...
TRANSMISSION_FILES_ROOT = '/home/what/Torrent/transmission-daemon'
...
TRANSCODER_HTTP_USERNAME = 'whatwmuser'
TRANSCODER_HTTP_PASSWORD = 'whatwmpass'
TRANSCODER_TEMP_DIR = '/home/what/temp/whatup.celery.{0}'.format(os.getpid())
TRANSCODER_ERROR_OUTPUT = '/home/what/temp/what_error.html'
TRANSCODER_FORMATS = ['V0', '320', 'V2']  # You can also add V2
